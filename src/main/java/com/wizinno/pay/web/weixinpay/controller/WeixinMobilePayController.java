package com.wizinno.pay.web.weixinpay.controller;

import com.wizinno.pay.common.model.Product;
import com.wizinno.pay.common.utils.AddressUtils;
import com.wizinno.pay.common.utils.DateUtil;
import com.wizinno.pay.data.Const;
import com.wizinno.pay.web.weixinpay.service.IWeixinPayService;
import com.wizinno.pay.web.weixinpay.util.ConfigUtil;
import com.wizinno.pay.web.weixinpay.util.HttpUtil;
import com.wizinno.pay.web.weixinpay.util.PayCommonUtil;
import com.wizinno.pay.web.weixinpay.util.XMLUtil;
import com.wizinno.pay.web.weixinpay.util.mobile.MobileUtil;
...
public class WeixinMobilePayController {
	...
	public String dopay(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		packageParams.put("openid", "oHNXov_VfOAnqnCDW2XocSkyWDMw");//用户openID
		...
		if(Const.SUCCESS.equals(returnCode)){
			...
			if(Const.SUCCESS.equals(resultCode)){
				//获取预支付交易会话标识
